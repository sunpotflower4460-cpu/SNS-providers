...
requireAll(inboxUi, ['育てる', '結果を再確認', '送信結果を確認しています', '明日へ', '今回は返さない', '今日やる理由'], 'Mission Inbox lost nurture coverage, unknown-result recovery, why-this-action, or snooze/dismiss labels.');
if (inboxUi.includes('もう一度送る')) {
